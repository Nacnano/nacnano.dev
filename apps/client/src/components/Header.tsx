...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between gap-4 border-b border-zinc-200 bg-white py-5 backdrop-blur supports-[backdrop-filter]:bg-white/85 dark:border-zinc-800 dark:bg-zinc-950 dark:supports-[backdrop-filter]:bg-zinc-950/85">
      <CustomLink
        href="/"
