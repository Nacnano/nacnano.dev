...
// The /activity page is served its whole retained window by the server render
// (see `loadInitialFeed`); this route exists for the live poll that surfaces
// visits arriving after that render, so every page it serves is small.
