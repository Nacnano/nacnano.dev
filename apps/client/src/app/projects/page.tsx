...
export const metadata = genPageMetaData({
  title: "Projects",
  description:
    "Shipped work by Chotpisit Adunsehawat — student platforms, an open-source course planner, and a machine-learning research project.",
});
  ...
  return (
    <div className="py-12 sm:py-16">
      ...
      <p className="mt-4 max-w-measure text-[1.0625rem] leading-[1.75] text-zinc-600 dark:text-zinc-400">
        Things I built or contributed to, with links to the live versions.
      </p>
